...
public class GoodsGalleryService {
	...
	public static final GoodsGalleryService me = new GoodsGalleryService();
	...
	public List<ShopGoodsGallery> queryList(Kv kv) {
		SqlPara sPara=Db.getSqlPara("goodsgallery.queryList", kv);
		List<ShopGoodsGallery> records=new ShopGoodsGallery().findAll(sPara.getSql());
		return records;
	}
