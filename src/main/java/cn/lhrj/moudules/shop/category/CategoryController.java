package cn.lhrj.moudules.shop.category;
...
public class CategoryController extends BaseProjectController{
	
	CategoryService srv=CategoryService.me;
	
	public void index() {
		render("/page/shop/category.html");
	}
	...
	public void getCategorySelectL1() {
