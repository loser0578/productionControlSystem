...
public class DenominationController extends BaseProjectController{

	DenominationService srv = DenominationService.me;
	
	public void index() {
		render("/page/shop/denomination.html");
	}
	public void list(@Para("") ShopDenomination model) {
		Kv para=new Kv();
     ...
     */
	public void info() {
		renderJson(Ret.ok("denomination", srv.queryObject(getParaToLong())));
	}
