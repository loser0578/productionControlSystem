...
public class OrderGoodsController extends BaseProjectController{
	
	OrderGoodsService srv=OrderGoodsService.me;
	public void index() {

		set("orderId", getPara("orderId"));
		render("/page/shop/orderPrint.html");
	}
	...
	public void queryAllReciver() {
		Kv para=new Kv();
		ShopOrderReciver reciver=new ShopOrderReciver().findById(getPara("orderId"));
		renderJson("list", srv.queryAllReciver(para.set("orderId",reciver.getParentId())));
	}
}
