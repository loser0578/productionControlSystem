...
TreeGrid.initColumn = function () {
    var columns = [
        ...
        {title: '编号', field: 'menu_id', visitable: false, align: 'center', valign: 'middle', width: '80px'},
...
var vm = new Vue({
    ...
    methods: {
        ...
        getMenu: function (menuId) {
            ...
            Ajax.request({
                ...
                successCallback: function (r) {
                    ...
                    var node = ztree.getNodeByParam("menu_id", vm.menu.parent_id);
                    ...
                    if (node) {
                        ...
                        node = ztree.getNodeByParam("menu_id", 0);
                        ztree.selectNode(node);
        ...
        saveOrUpdate: function (event) {
            ...
            var url = vm.menu.menu_id == null ? "../sys/menu/save" : "../sys/menu/update";
            Ajax.request({
                url: url,
        ...
        menuTree: function () {
            openWindow({
                ...
                btn1: function (index) {
                    ...
                    vm.menu.parentId = node[0].menu_id;
